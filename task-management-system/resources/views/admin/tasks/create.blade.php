...
<div style="max-width: 800px; margin: 0 auto; padding: 20px;">
    <h1 style="color: #333; margin-bottom: 30px; font-size: 2.5rem; font-weight: bold;">Create Task</h1>
        ...
        <form action="{{ route('admin.tasks.store') }}" method="POST">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <textarea id="description" 
                          name="description" 
                          rows="3"
                          style="width: 100%; padding: 10px; border: 1px solid #ced4da; border-radius: 4px; font-size: 16px; resize: vertical; transition: border-color 0.3s ease, box-shadow 0.3s ease; font-family: inherit;"></textarea>
            </div>
